...
plot(0:130, dpois(0:130, lambda[1]), xlim=c(0,130), ylim=c(0,0.2), type='l', xlab=expression(lambda), ylab="f(x)", main=expression(paste("Some examples of normal approximations to the Poisson distribution w.r.t.",lambda)))
lines(0:130, dpois(0:130, lambda[2]), col='green')
lines(0:130, dpois(0:130, lambda[3]), col='red')
lines(0:130, dpois(0:130, lambda[4]), col='blue')
lines(0:130, dpois(0:130, lambda[5]), col='purple')

lines(0:130, dnorm(0:130, lambda[1], sqrt(lambda[1])), col='orange')
lines(0:130, dnorm(0:130, lambda[2], sqrt(lambda[2])), col='orange')
lines(0:130, dnorm(0:130, lambda[3], sqrt(lambda[3])), col='orange')
lines(0:130, dnorm(0:130, lambda[4], sqrt(lambda[4])), col='orange')
lines(0:130, dnorm(0:130, lambda[5], sqrt(lambda[5])), col='orange')
```
