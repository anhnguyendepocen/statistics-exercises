...
# To obtain names of variables from dni3 
sublist <- sub(" L.",".Length", sub(" W.",".Width", dni3[[2]]))

# To create new dataframe. Function 'aperm' is used to transpose an
# array by permuting its dimensions and optionally resizing it.
ii <- data.frame(matrix(aperm(iris3, c(1,3,2)), ncol = 4,
                 dimnames = list(NULL, sublist)), Species = species)
