...
**a) Use the following code to plotlog2 (area)versus elevation, adding labeling information (there is an extreme value of area that makes a logarithmic scale pretty much essential).**
...
In cases where the score seems very high the most useful plot is the first one $plot(BDI \sim age, data=socsupport)$ because the outliars apear explicitly.
...
```{r echo=TRUE}
dni3 <- dimnames(iris3) # To obtain dimension names of iris3 dataset. Output:
# 1.NULL
# 2. 'Sepal L.' 'Sepal W.' 'Petal L.' 'Petal W.'
# 3. 'Setosa' 'Versicolor' 'Virginica'

# To create new dataframe. Function 'aperm' is used to transpose an array by 
# permuting its dimensions and optionally resizing it.
