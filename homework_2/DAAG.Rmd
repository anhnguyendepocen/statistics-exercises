...
for (i in 1:10) {
  x <- rpois(7, 78.3)
  print(paste("Mean: ", mean(x), " Var: ", var(x)))
}
```

Variance in observed data is much higher than the one obtained by sampling from a Poisson distribution, thus Poisson model is probably inappropriate to model these data.
